...
> Начиная с версии 2.0.0 при запуске и инициализации приложения (а так же при присоеденении к процессу из параметра ProcessName) не происходит поиск и регистрация окна процесса. Поиск окна происходит при первом обращении к методам выполняющим поиск элементов или другие действия задействующие объект окна.
...
* Сброс корневого элемента. При первом обращении происходит поиск главного окна нового процесса и установка в качестве корневого элемента.
